...
## the output is  a graph stored as TechTrend_"TechTrendSearchString".png
## the search is not case sensitive

## This version includes some enhanements to teh graphics

## This program reads the "cleaned" BigExascalar data set
...
hightechtable<-hightechtable[complete.cases(hightechtable$power),]
...
plot(as.Date(TechTrend$date, origin="1970-01-01"), TechTrend$power,
     ...
     pch=22)
par(new=TRUE)
plot(as.Date(hightechtable$date, origin="1970-01-01"), hightechtable$power,
     ylim=c(20,20000),
     xlim = c(14000, 16500),
     main = "",
     type="o",
...
plot(as.Date(TechTrend$date, origin="1970-01-01"), TechTrend$rmax,
     ...
     pch=22)
par(new=TRUE)
plot(as.Date(hightechtable$date, origin="1970-01-01"), hightechtable$rmax,
     ylim=c(10^3,10^8),
     xlim = c(14000, 16500),
     main = "",
     type="o",
